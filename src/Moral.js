...
const questionsData = [
  ...
  "får man snacka skit om en kollega",
  "får man rat:a en kollega om den suger",
  ...
  "får man låna någons kläder och aldrig lämna tillbaka dem",
  ...
  "får man hetsa någon att berusa sig",
  "får man pressa en kompis till sex",
